...
func Edit(w http.ResponseWriter, r *http.Request) {
	...
	selecionarProduto := models.BuscaProduto(idProduto)

	temp.ExecuteTemplate(w, "edit", selecionarProduto)
}
...
func Update(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		models.AtualizaProduto(nome, descricao, precoConvertido, quantidadeConvertido, idConvertido)
	}
